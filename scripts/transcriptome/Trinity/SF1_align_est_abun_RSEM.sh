...
#SBATCH --qos=long
#SBATCH --job-name SF1_align_est_abun_RSEM
#SBATCH --error job_reports/SF1_align_est_abun_RSEM.error          
#SBATCH --output job_reports/SF1_align_est_abun_RSEM.output  
...
--est_method RSEM \
--aln_method $TO/bowtie2.bam \
--seqType fq \
--samples_file $S \
--output_dir $TO/est_abund_RSEM \
--SS_lib_type RF \
--thread_count 20 \

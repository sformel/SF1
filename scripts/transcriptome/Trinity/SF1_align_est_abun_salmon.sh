...
#SBATCH --qos=long
#SBATCH --job-name SF1_align_est_abun_salmon
#SBATCH --error job_reports/SF1_align_est_abun_salmon.error          
#SBATCH --output job_reports/SF1_align_est_abun_salmon.output  
...
--samples_file $S \
--est_method salmon \
--output_dir $TO/est_abund_salmon \
--SS_lib_type RF \
--thread_count 20 \

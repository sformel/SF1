...
#SBATCH --qos=long
#SBATCH --job-name SF1_Trinity_test_1Feb2019_2
#SBATCH --error job_reports/SF1_Trinity_test_1Feb2019_2.error          
#SBATCH --output job_reports/SF1_Trinity_test_1Feb2019_2.output  
...
#output folder
O='Trinity_test_out_SF1_1Feb2019_2'

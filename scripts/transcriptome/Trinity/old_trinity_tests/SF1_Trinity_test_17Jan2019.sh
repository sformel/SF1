...
#SBATCH --qos=long
#SBATCH --error job_reports/SF1_Trinity_17Jan2019.error          
#SBATCH --output job_reports/SF1_Trinity_17Jan2019.output  
#SBATCH --job-name SF1_Trinity_test_17Jan2019
...
O='Trinity_test_out_SF1_17Jan2019'
